function check_seltzo_two_sum_lemmas!(
    ...
    checker("SELTZO-TwoSum-ALL1-MM01-D1-X",
        (CLASS_X == ALL1) & (CLASS_Y == MM01) &
        (ex > fy + p) & (ex < ey + p)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ALL1-MM01-D1-Y",
        (CLASS_Y == ALL1) & (CLASS_X == MM01) &
        (ey > fx + p) & (ey < ex + p)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ALL1-MM01-D1A-X",
        (CLASS_X == ALL1) & (CLASS_Y == MM01) &
        (ex == fy + p)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ALL1-MM01-D1A-Y",
        (CLASS_Y == ALL1) & (CLASS_X == MM01) &
        (ey == fx + p)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ALL1-MM01-D1B-X",
        (CLASS_X == ALL1) & (CLASS_Y == MM01) &
        (ex == fy + (p - 1))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ALL1-MM01-D1B-Y",
        (CLASS_Y == ALL1) & (CLASS_X == MM01) &
        (ey == fx + (p - 1))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ALL1-MM01-D1C0-X",
        (CLASS_X == ALL1) & (CLASS_Y == MM01) &
        (ex == fy + (p - 2)) & (ex > ey + 1)
    ) do lemma
        add_case!(lemma, SELTZORange(sx, 1, 0, ex, ey, fy), pos_zero)
    end
    checker("SELTZO-TwoSum-ALL1-MM01-D1C0-Y",
        (CLASS_Y == ALL1) & (CLASS_X == MM01) &
        (ey == fx + (p - 2)) & (ey > ex + 1)
    ) do lemma
    ...
    checker("SELTZO-TwoSum-ALL1-MM01-D1C1-X",
        (CLASS_X == ALL1) & (CLASS_Y == MM01) &
        (ex == fy + (p - 2)) & (ex == ey + 1)
    ) do lemma
        add_case!(lemma, SELTZORange(sx, 0, 0, ex, fy, fy), pos_zero)
    end
    checker("SELTZO-TwoSum-ALL1-MM01-D1C1-Y",
        (CLASS_Y == ALL1) & (CLASS_X == MM01) &
        (ey == fx + (p - 2)) & (ey == ex + 1)
    ) do lemma
