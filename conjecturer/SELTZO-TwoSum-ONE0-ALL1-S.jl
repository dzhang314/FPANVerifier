function check_seltzo_two_sum_lemmas!(
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S3-X",
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S3-Y",
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S3A-X",
        (CLASS_X == ONE0) & (CLASS_Y == ALL1) &
        (fx < ey) & (ex > ey + 1) & (ex == fx + (p - 2))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S3A-Y",
        (CLASS_Y == ONE0) & (CLASS_X == ALL1) &
        (fy < ex) & (ey > ex + 1) & (ey == fy + (p - 2))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S3B-X",
        (CLASS_X == ONE0) & (CLASS_Y == ALL1) &
        (fx == ey) & (ex < fx + (p - 2))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S3B-Y",
        (CLASS_Y == ONE0) & (CLASS_X == ALL1) &
        (fy == ex) & (ey < fy + (p - 2))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S3AB-X",
        (CLASS_X == ONE0) & (CLASS_Y == ALL1) &
        (fx == ey) & (ex == fx + (p - 2))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S3AB-Y",
        (CLASS_Y == ONE0) & (CLASS_X == ALL1) &
        (fy == ex) & (ey == fy + (p - 2))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S3C-X",
        (CLASS_X == ONE0) & (CLASS_Y == ALL1) &
        (ex == ey + 1) & (ex < fx + (p - 2))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S3C-Y",
        (CLASS_Y == ONE0) & (CLASS_X == ALL1) &
        (ey == ex + 1) & (ey < fy + (p - 2))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S3AC-X",
        (CLASS_X == ONE0) & (CLASS_Y == ALL1) &
        (ex == ey + 1) & (ex == fx + (p - 2))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S3AC-Y",
        (CLASS_Y == ONE0) & (CLASS_X == ALL1) &
        (ey == ex + 1) & (ey == fy + (p - 2))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S4-X",
        (CLASS_X == ONE0) & (CLASS_Y == ALL1) &
        (fx > ey + 1) & (ex < ey + p)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S4-Y",
        (CLASS_Y == ONE0) & (CLASS_X == ALL1) &
        (fy > ex + 1) & (ey < ex + p)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S4A-X",
        (CLASS_X == ONE0) & (CLASS_Y == ALL1) &
        (fx == ey + 1)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S4A-Y",
        (CLASS_Y == ONE0) & (CLASS_X == ALL1) &
        (fy == ex + 1)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S4B-X",
        (CLASS_X == ONE0) & (CLASS_Y == ALL1) &
        (ex == ey + p) & (fx > ey + 1)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-S4B-Y",
        (CLASS_Y == ONE0) & (CLASS_X == ALL1) &
        (ey == ex + p) & (fy > ex + 1)
    ) do lemma
        add_case!(lemma,
