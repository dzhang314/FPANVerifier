function check_seltzo_two_sum_lemmas!(
    ...
    checker("SELTZO-TwoSum-R0R1-POW2-D1B0-X",
        (CLASS_X == R0R1) & (CLASS_Y == POW2) &
        (fx == ey) & (ex < fx + (p - 1))
    ) do lemma
        add_case!(lemma, SELTZORange(sx, 0, 1, ex, ey - 1, ey), pos_zero)
    end
    checker("SELTZO-TwoSum-R0R1-POW2-D1B0-Y",
        (CLASS_Y == R0R1) & (CLASS_X == POW2) &
        (fy == ex) & (ey < fy + (p - 1))
    ) do lemma
    ...
    checker("SELTZO-TwoSum-R0R1-POW2-D1B1-X",
        (CLASS_X == R0R1) & (CLASS_Y == POW2) &
        (fx == ey) & (ex == fx + (p - 1))
    ) do lemma
        add_case!(lemma, SELTZORange(sx, 0, 0, ex, ey - 1, ex), pos_zero)
    end
    checker("SELTZO-TwoSum-R0R1-POW2-D1B1-Y",
        (CLASS_Y == R0R1) & (CLASS_X == POW2) &
        (fy == ex) & (ey == fy + (p - 1))
    ) do lemma
    ...
    checker("SELTZO-TwoSum-R0R1-POW2-DB20-X",
        (CLASS_X == R0R1) & (CLASS_Y == POW2) &
        (ex == ey + p) & (ex < fx + (p - 1))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-R0R1-POW2-DB20-Y",
        (CLASS_Y == R0R1) & (CLASS_X == POW2) &
        (ey == ex + p) & (ey < fy + (p - 1))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-R0R1-POW2-DB21-X",
        (CLASS_X == R0R1) & (CLASS_Y == POW2) &
        (ex == ey + p) & (ex == fx + (p - 1))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-R0R1-POW2-DB21-Y",
        (CLASS_Y == R0R1) & (CLASS_X == POW2) &
        (ey == ex + p) & (ey == fy + (p - 1))
    ) do lemma
        add_case!(lemma,
