function check_seltzo_two_sum_lemmas!(
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-S1A0-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO0) &
        (ex == fy + p) & (ey < fy + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-S1A0-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO0) &
        (ey == fx + p) & (ex < fx + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-S1A1-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO0) &
        (ex == fy + p) & (ey == fy + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-S1A1-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO0) &
        (ey == fx + p) & (ex == fx + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-S1B-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO0) &
        (ex > fy + p) & (ex < ey + p) & (ey == fy + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-S1B-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO0) &
        (ey > fx + p) & (ey < ex + p) & (ex == fx + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-S2A0-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO0) &
        (ex == fy + (p - 1)) & (ey < fy + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-S2A0-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO0) &
        (ey == fx + (p - 1)) & (ex < fx + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-S2A1-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO0) &
        (ex == fy + (p - 1)) & (ey == fy + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-S2A1-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO0) &
        (ey == fx + (p - 1)) & (ex == fx + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-S3A0-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO0) &
        (ex == fy + (p - 2)) & (ey < fy + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-S3A0-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO0) &
        (ey == fx + (p - 2)) & (ex < fx + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-S3A1-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO0) &
        (ex == ey + 1) & (ey == fy + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-S3A1-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO0) &
        (ey == ex + 1) & (ex == fx + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-SB0-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO0) &
        (ex == ey + p) & (ey < fy + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-SB0-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO0) &
        (ey == ex + p) & (ex < fx + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-SB1-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO0) &
        (ex == ey + p) & (ey == fy + (p - 3))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO0-SB1-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO0) &
        (ey == ex + p) & (ex == fx + (p - 3))
    ) do lemma
        add_case!(lemma,
