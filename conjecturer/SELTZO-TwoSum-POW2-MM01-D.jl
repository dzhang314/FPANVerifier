function check_seltzo_two_sum_lemmas!(
    ...
    checker("SELTZO-TwoSum-POW2-MM01-D1A-X",
        (CLASS_X == POW2) & (CLASS_Y == MM01) &
        (ex == fy + (p + 1))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-MM01-D1A-Y",
        (CLASS_Y == POW2) & (CLASS_X == MM01) &
        (ey == fx + (p + 1))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-MM01-D2A-X",
        (CLASS_X == POW2) & (CLASS_Y == MM01) &
        (ex == fy + p)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-MM01-D2A-Y",
        (CLASS_Y == POW2) & (CLASS_X == MM01) &
        (ey == fx + p)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-MM01-D3A0-X",
        (CLASS_X == POW2) & (CLASS_Y == MM01) &
        (ex == fy + (p - 1)) & (ey < fy + (p - 3))
    ) do lemma
        add_case!(lemma, SELTZORange(sx, 1, 1, ex - 1, ey, fy + 1), pos_zero)
    end
    checker("SELTZO-TwoSum-POW2-MM01-D3A0-Y",
        (CLASS_Y == POW2) & (CLASS_X == MM01) &
        (ey == fx + (p - 1)) & (ex < fx + (p - 3))
    ) do lemma
    ...
    checker("SELTZO-TwoSum-POW2-MM01-D3A1-X",
        (CLASS_X == POW2) & (CLASS_Y == MM01) &
        (ex == fy + (p - 1)) & (ey == fy + (p - 3))
    ) do lemma
        add_case!(lemma, SELTZORange(sx, 0, 1, ex - 1, fy, fy + 1), pos_zero)
    end
    checker("SELTZO-TwoSum-POW2-MM01-D3A1-Y",
        (CLASS_Y == POW2) & (CLASS_X == MM01) &
        (ey == fx + (p - 1)) & (ex == fx + (p - 3))
    ) do lemma
    ...
    checker("SELTZO-TwoSum-POW2-MM01-DB-X",
        (CLASS_X == POW2) & (CLASS_Y == MM01) &
        (ex == ey + (p + 1))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-MM01-DB-Y",
        (CLASS_Y == POW2) & (CLASS_X == MM01) &
        (ey == ex + (p + 1))
    ) do lemma
        add_case!(lemma,
