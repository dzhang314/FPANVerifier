function check_seltzo_two_sum_lemmas!(
    ...
    checker("SELTZO-TwoSum-ONE1-TWO0-DE4-X",
        (CLASS_X == ONE1) & (CLASS_Y == TWO0) &
        (ex == ey) & (fx < fy + 1) & (fx + 2 > fy) & (ey == fy + 3)
    ) do lemma
        add_case!(lemma, SELTZORange(sy, 0, 0, ex - 1, ex - 3, ex - (p - 1)), pos_zero)
    end
    checker("SELTZO-TwoSum-ONE1-TWO0-DE4-Y",
        (CLASS_Y == ONE1) & (CLASS_X == TWO0) &
        (ey == ex) & (fy < fx + 1) & (fy + 2 > fx) & (ex == fx + 3)
    ) do lemma
        add_case!(lemma, SELTZORange(sx, 0, 0, ey - 1, ey - 3, ey - (p - 1)), pos_zero)
    ...
    checker("SELTZO-TwoSum-ONE1-TWO0-DE5-X",
        (CLASS_X == ONE1) & (CLASS_Y == TWO0) &
        (ex == ey) & (fx + 2 == fy) & (ey == fy + 2)
    ) do lemma
        add_case!(lemma, SELTZORange(sy, 0, 0, ex - 1, fx - 1, ex - (p - 1)), pos_zero)
    end
    checker("SELTZO-TwoSum-ONE1-TWO0-DE5-Y",
        (CLASS_Y == ONE1) & (CLASS_X == TWO0) &
        (ey == ex) & (fy + 2 == fx) & (ex == fx + 2)
    ) do lemma
    ...
    checker("SELTZO-TwoSum-ONE1-TWO0-DE6-X",
        (CLASS_X == ONE1) & (CLASS_Y == TWO0) &
        (ex == ey) & (ex == fx + 2) & (ey == fy + 3)
    ) do lemma
        add_case!(lemma, SELTZORange(sy, 0, 0, ex - 1, fx - 3, ex - (p - 1)), pos_zero)
    end
    checker("SELTZO-TwoSum-ONE1-TWO0-DE6-Y",
        (CLASS_Y == ONE1) & (CLASS_X == TWO0) &
        (ey == ex) & (ey == fy + 2) & (ex == fx + 3)
    ) do lemma
