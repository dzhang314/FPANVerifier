...
function check_seltzo_two_sum_lemmas(
    ...
    for x in abstract_inputs, y in abstract_inputs
        ...
        if x_zero | y_zero ################################### ZERO LEMMA FAMILY
            ...
            checker("SELTZO-TwoSum-G10-POW2-D1-X",
                diff_sign & (cx == G10) & (cy == POW2) &
                (ex > ey + 1) & (ey > fx)
            ) do lemma
                add_case!(lemma, SELTZORange(sx, 1, 0, ex, ey, gx), pos_zero)
            end
            checker("SELTZO-TwoSum-G10-POW2-D1-Y",
                diff_sign & (cy == G10) & (cx == POW2) &
                (ey > ex + 1) & (ex > fy)
            ) do lemma
                add_case!(lemma, SELTZORange(sy, 1, 0, ey, ex, gy), pos_zero)
            end
            ...
            checker("SELTZO-TwoSum-POW2-TWO0-D1-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 1, 0, ex-1, ey, ey+1),
                    SELTZORange(~sy, 1, 0, fy, gy-1, gy-2))
            end
            checker("SELTZO-TwoSum-POW2-TWO0-D1-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 1, 0, ey-1, ex, ex+1),
                    SELTZORange(~sx, 1, 0, fx, gx-1, gx-2))
            end
            ...
            checker("SELTZO-TwoSum-POW2-G10-D3-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 1, 0, ex-1, ey, fx+1:fy-1),
                    SELTZORange(sy, 0, 0, gy, gy-p, gy))
                add_case!(lemma,
                    SELTZORange(sx, 1, 0, ex-1, ey, fy+1),
                    SELTZORange(sy, 0, 0, gy, gy-p, gy))
                add_case!(lemma,
                    SELTZORange(sx, 1, 0, ex-1, ey, fx+1:fy),
                    SELTZORange(~sy, 0, 0, gy, gy-p, gy))
                add_case!(lemma,
                    SELTZORange(sx, 1, 1, ex-1, ey, fx+1:fy-1),
                    SELTZORange(sy, 0, 0, gy, gy-p, gy))
                add_case!(lemma,
            ...
            checker("SELTZO-TwoSum-POW2-G10-D3-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 1, 0, ey-1, ex, fy+1:fx-1),
                    SELTZORange(sx, 0, 0, gx, gx-p, gx))
                add_case!(lemma,
                    SELTZORange(sy, 1, 0, ey-1, ex, fx+1),
                    SELTZORange(sx, 0, 0, gx, gx-p, gx))
                add_case!(lemma,
                    SELTZORange(sy, 1, 0, ey-1, ex, fy+1:fx),
                    SELTZORange(~sx, 0, 0, gx, gx-p, gx))
                add_case!(lemma,
                    SELTZORange(sy, 1, 1, ey-1, ex, fy+1:fx-1),
                    SELTZORange(sx, 0, 0, gx, gx-p, gx))
                add_case!(lemma,
            ...
            checker("SELTZO-TwoSum-R1R0-G00-S2-X",
                ...
                add_case!(lemma,
                    ...
                    SELTZORange(~sy, 0, 0, gy, gy-p, gy))
                add_case!(lemma,
                    SELTZORange(sx, 0, 0, ex+1, fy, gy+2:fy-1),
                    SELTZORange(~sy, 0, 0, gy, gy-p, gy))
                add_case!(lemma,
                    SELTZORange(sx, 0, 0, ex+1, fy, gy+2:fy),
                    SELTZORange(sy, 0, 0, gy, gy-p, gy))
            end
            checker("SELTZO-TwoSum-R1R0-G00-S2-Y",
                ...
                add_case!(lemma,
                    ...
                    SELTZORange(~sx, 0, 0, gx, gx-p, gx))
                add_case!(lemma,
                    SELTZORange(sy, 0, 0, ey+1, fx, gx+2:fx-1),
                    SELTZORange(~sx, 0, 0, gx, gx-p, gx))
                add_case!(lemma,
                    SELTZORange(sy, 0, 0, ey+1, fx, gx+2:fx),
                    SELTZORange(sx, 0, 0, gx, gx-p, gx))
            end
            ...
            checker("SELTZO-TwoSum-G10-G00-D1-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 1, 1, ex, fx, gx),
                    SELTZORange(sy, 0, 0, fy, gy:gy+1, gy))
                add_case!(lemma,
                    SELTZORange(sx, 1, 1, ex, fx, gx),
                    SELTZORange(sy, 1, 0, fy, gy-1, gy))
                add_case!(lemma,
            ...
            checker("SELTZO-TwoSum-G10-G00-D1-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 1, 1, ey, fy, gy),
                    SELTZORange(sx, 0, 0, fx, gx:gx+1, gx))
                add_case!(lemma,
                    SELTZORange(sy, 1, 1, ey, fy, gy),
                    SELTZORange(sx, 1, 0, fx, gx-1, gx))
                add_case!(lemma,
            ...
            checker("SELTZO-TwoSum-TWO1-G10-D1-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 1, 0, ex-1, ey, gx-1),
                    SELTZORange(sy, 0, 0, gy, gy-p, gy))
                add_case!(lemma,
                    SELTZORange(sx, 1, 0, ex-1, ey, gx),
                    SELTZORange(sy, 0, 0, gy, gy-p, gy))
            ...
            checker("SELTZO-TwoSum-TWO1-G10-D1-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 1, 0, ey-1, ex, gy-1),
                    SELTZORange(sx, 0, 0, gx, gx-p, gx))
                add_case!(lemma,
                    SELTZORange(sy, 1, 0, ey-1, ex, gy),
                    SELTZORange(sx, 0, 0, gx, gx-p, gx))
            ...
            checker("SELTZO-TwoSum-POW2-G00-S3-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 0, 1, ex, fx+1, fx+2),
                    SELTZORange(~sy, 0, 0, fx-1, gy:fy-1, gy))
            end
            checker("SELTZO-TwoSum-POW2-G00-S3-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 0, 1, ey, fy+1, fy+2),
                    SELTZORange(~sx, 0, 0, fy-1, gx:fx-1, gx))
            end
            ...
            checker("SELTZO-TwoSum-G01-POW2-S2-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 0, 0, ex+1, fx, gx+1:fx),
                    SELTZORange(sy, 0, 0, fy+1, fy-(p-1), fy+1))
            end
            checker("SELTZO-TwoSum-G01-POW2-S2-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 0, 0, ey+1, fy, gy+1:fy),
                    SELTZORange(sx, 0, 0, fx+1, fx-(p-1), fx+1))
            end
            ...
            checker("SELTZO-TwoSum-POW2-MM10-S3-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 0, 1, ex, fx+1, fx+2),
                    SELTZORange(~sy, 1, 0, fx-1, fy, fx-(p-1)))
            end
            checker("SELTZO-TwoSum-POW2-MM10-S3-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 0, 1, ey, fy+1, fy+2),
                    SELTZORange(~sx, 1, 0, fy-1, fx, fy-(p-1)))
            end
            ...
            checker("SELTZO-TwoSum-POW2-G01-D4-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 1, 1, ex-1, ey, ex-1),
                    SELTZORange(~sy, 0, 0, ey-1, gy:fy-1, gy-1))
            end
            checker("SELTZO-TwoSum-POW2-G01-D4-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 1, 1, ey-1, ex, ey-1),
                    SELTZORange(~sx, 0, 0, ex-1, gx:fx-1, gx-1))
            end
            ...
            checker("SELTZO-TwoSum-R0R1-R0R1-D2-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 1, 0, ex-1, gy, gy+1),
                    SELTZORange(~sy, 0, 0, ey-(p-1), ey-(p+p-1), ey-(p-1)))
            end
            checker("SELTZO-TwoSum-R0R1-R0R1-D2-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 1, 0, ey-1, gx, gx+1),
                    SELTZORange(~sx, 0, 0, ex-(p-1), ex-(p+p-1), ex-(p-1)))
            end
            ...
            checker("SELTZO-TwoSum-POW2-G01-S3-X",
                ...
                add_case!(lemma,
                    ...
                    SELTZORange(sy, 0, 0, fx-1, fx-(p+1), fx-1))
                add_case!(lemma,
                    SELTZORange(sx, 0, 1, ex, ey, gy+2:fy-1),
                    SELTZORange(sy, 0, 0, fx-1, fx-(p+1), fx-1))
                add_case!(lemma,
            ...
            checker("SELTZO-TwoSum-POW2-G01-S3-Y",
                ...
                add_case!(lemma,
                    ...
                    SELTZORange(sx, 0, 0, fy-1, fy-(p+1), fy-1))
                add_case!(lemma,
                    SELTZORange(sy, 0, 1, ey, ex, gx+2:fx-1),
                    SELTZORange(sx, 0, 0, fy-1, fy-(p+1), fy-1))
                add_case!(lemma,
            ...
            checker("SELTZO-TwoSum-G00-ONE1-D1-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 0, 0, ex, fx, gx+1:fx),
                    SELTZORange(sy, 0, 0, fy, fy-p, fy))
            end
            checker("SELTZO-TwoSum-G00-ONE1-D1-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 0, 0, ey, fy, gy+1:fy),
                    SELTZORange(sx, 0, 0, fx, fx-p, fx))
            end
            ...
            checker("SELTZO-TwoSum-POW2-TWO0-D2-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 1, 1, ex-1, ey, ex-1),
                    SELTZORange(~sy, 1, 0, fy, gy-1, ey-(p-1)))
            end
            checker("SELTZO-TwoSum-POW2-TWO0-D2-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 1, 1, ey-1, ex, ey-1),
                    SELTZORange(~sx, 1, 0, fx, gx-1, ex-(p-1)))
            end
            ...
            checker("SELTZO-TwoSum-POW2-ONE1-D7-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 1, 1, ex-1, fx-1, ex-1),
                    SELTZORange(sy, 0, 0, fy, fy-p, fy))
            end
            checker("SELTZO-TwoSum-POW2-ONE1-D7-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 1, 1, ey-1, fy-1, ey-1),
                    SELTZORange(sx, 0, 0, fx, fx-p, fx))
            end
            ...
            checker("SELTZO-TwoSum-G00-ONE1-D2-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 1, 0, ex-1, ey-1, gx),
                    SELTZORange(sy, 0, 0, fy, fy-p, fy))
            end
            checker("SELTZO-TwoSum-G00-ONE1-D2-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 1, 0, ey-1, ex-1, gy),
                    SELTZORange(sx, 0, 0, fx, fx-p, fx))
            end
            ...
            checker("SELTZO-TwoSum-TWO1-R1R0-D4-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 1, 0, ex-1, gx-1, gx),
                    SELTZORange(~sy, 0, 0, gy, fy-(p-1), gy))
            end
            checker("SELTZO-TwoSum-TWO1-R1R0-D4-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 1, 0, ey-1, gy-1, gy),
                    SELTZORange(~sx, 0, 0, gx, fx-(p-1), gx))
            end
            ...
            checker("SELTZO-TwoSum-ALL1-R1R0-S5-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 0, 0, ex+1, ey, ey),
                    SELTZORange(sy, 0, 0, fy, fx-(p-1), fy))
            end
            checker("SELTZO-TwoSum-ALL1-R1R0-S5-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 0, 0, ey+1, ex, ex),
                    SELTZORange(sx, 0, 0, fx, fy-(p-1), fx))
            end
            ...
            checker("SELTZO-TwoSum-R1R0-G10-S1-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 0, 1, ex+1, ey, gx),
                    SELTZORange(sy, 0, 0, gy, gy-p, gy))
                add_case!(lemma,
                    SELTZORange(sx, 0, 1, ex+1, ey, gx),
                    SELTZORange(sy, 1, 0, fy-1, gy-1, gy))
            end
            checker("SELTZO-TwoSum-R1R0-G10-S1-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 0, 1, ey+1, ex, gy),
                    SELTZORange(sx, 0, 0, gx, gx-p, gx))
                add_case!(lemma,
                    SELTZORange(sy, 0, 1, ey+1, ex, gy),
                    SELTZORange(sx, 1, 0, fx-1, gx-1, gx))
            end
            ...
            checker("SELTZO-TwoSum-POW2-G00-S7-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 0, 1, ex, ey, fx+2),
                    SELTZORange(~sy, 1, 0, fx-1, gy-1, gy))
            end
            checker("SELTZO-TwoSum-POW2-G00-S7-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 0, 1, ey, ex, fy+2),
                    SELTZORange(~sx, 1, 0, fy-1, gx-1, gx))
            end
            ...
            checker("SELTZO-TwoSum-ONE0-TWO1-S1-X",
                ...
                add_case!(lemma,
                    ...
                    SELTZORange(sy, 0, 0, gy-1, gy-(p+1), gy-1))
            end
            checker("SELTZO-TwoSum-ONE0-TWO1-S1-Y",
                ...
                add_case!(lemma,
                    ...
                    SELTZORange(sx, 0, 0, gx-1, gx-(p+1), gx-1))
            end
            ...
            checker("SELTZO-TwoSum-R1R0-G01-S1-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 0, 0, ex+1, ex-(p-1), ex+1),
                    SELTZORange(sy, 0, 0, fy, gy-1, fx-(p-2)))
                add_case!(lemma,
                    SELTZORange(sx, 0, 0, ex+1, ex-(p-1), ex+1),
                    SELTZORange(sy, 1, 0, fy, gy, fx-(p-2)))
            end
            checker("SELTZO-TwoSum-R1R0-G01-S1-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 0, 0, ey+1, ey-(p-1), ey+1),
                    SELTZORange(sx, 0, 0, fx, gx-1, fy-(p-2)))
                add_case!(lemma,
                    SELTZORange(sy, 0, 0, ey+1, ey-(p-1), ey+1),
                    SELTZORange(sx, 1, 0, fx, gx, fy-(p-2)))
            end
            ...
            checker("SELTZO-TwoSum-POW2-G00-D9-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 1, 1, ex-1, ey, ey),
                    SELTZORange(~sy, 1, 0, gy+1, gy-1, gy))
                add_case!(lemma,
                    SELTZORange(sx, 1, 1, ex-1, ey, ey),
                    SELTZORange(~sy, 1, 0, fy-1, gy-1, gy))
                add_case!(lemma,
                    SELTZORange(sx, 1, 1, ex-1, ey, ey),
                    SELTZORange(~sy, 0, 0, fy-1, gy, gy))
            end
            checker("SELTZO-TwoSum-POW2-G00-D9-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 1, 1, ey-1, ex, ex),
                    SELTZORange(~sx, 1, 0, gx+1, gx-1, gx))
                add_case!(lemma,
                    SELTZORange(sy, 1, 1, ey-1, ex, ex),
                    SELTZORange(~sx, 1, 0, fx-1, gx-1, gx))
                add_case!(lemma,
                    SELTZORange(sy, 1, 1, ey-1, ex, ex),
                    SELTZORange(~sx, 0, 0, fx-1, gx, gx))
            end
            ...
            checker("SELTZO-TwoSum-G00-R0R1-D2-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 0, 0, ex, gx, gx),
                    SELTZORange(sy, 1, 0, fy, gx-(p-2), gx-(p-3)))
                add_case!(lemma,
                    SELTZORange(sx, 0, 0, ex, fx-1, gx),
                    SELTZORange(sy, 1, 0, fy, gx-(p-2), gx-(p-3)))
            end
            checker("SELTZO-TwoSum-G00-R0R1-D2-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 0, 0, ey, gy, gy),
                    SELTZORange(sx, 1, 0, fx, gy-(p-2), gy-(p-3)))
                add_case!(lemma,
                    SELTZORange(sy, 0, 0, ey, fy-1, gy),
                    SELTZORange(sx, 1, 0, fx, gy-(p-2), gy-(p-3)))
            end
            ...
            checker("SELTZO-TwoSum-ONE0-MM10-D1-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 1, 0, ex, fx, fx+1),
                    SELTZORange(sy, 0, 0, fy, gy-1, ey-(p-1)))
            end
            checker("SELTZO-TwoSum-ONE0-MM10-D1-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 1, 0, ey, fy, fy+1),
                    SELTZORange(sx, 0, 0, fx, gx-1, ex-(p-1)))
            end
            ...
            checker("SELTZO-TwoSum-R1R0-R1R0-S4-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 0, 0, ex+1, ey, gx+1),
                    SELTZORange(sy, 0, 0, fx, fy-(p-1), fx))
            end
            checker("SELTZO-TwoSum-R1R0-R1R0-S4-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 0, 0, ey+1, ex, gy+1),
                    SELTZORange(sx, 0, 0, fy, fx-(p-1), fy))
            end
            ...
            checker("SELTZO-TwoSum-POW2-MM10-D7-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 1, 1, ex-1, ey, ey),
                    SELTZORange(sy, 1, 0, gy-1, ey-p, ey-(p-1)))
            end
            checker("SELTZO-TwoSum-POW2-MM10-D7-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 1, 1, ey-1, ex, ex),
                    SELTZORange(sx, 1, 0, gx-1, ex-p, ex-(p-1)))
            end
            ...
            checker("SELTZO-TwoSum-G10-R1R0-D3-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 1, 0, ex, fx, gx+1:fx-1),
                    SELTZORange(~sy, 0, 0, gy, fy-(p-1), gy))
                add_case!(lemma,
                    SELTZORange(sx, 1, 0, ex, fx, fx+1),
                    SELTZORange(~sy, 0, 0, gy, fy-(p-1), gy))
            ...
            checker("SELTZO-TwoSum-G10-R1R0-D3-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 1, 0, ey, fy, gy+1:fy-1),
                    SELTZORange(~sx, 0, 0, gx, fx-(p-1), gx))
                add_case!(lemma,
                    SELTZORange(sy, 1, 0, ey, fy, fy+1),
                    SELTZORange(~sx, 0, 0, gx, fx-(p-1), gx))
            ...
            checker("SELTZO-TwoSum-POW2-G00-D11-X",
                ...
                add_case!(lemma,
                    SELTZORange(sx, 1, 1, ex-1, ey, ex-1),
                    SELTZORange(~sy, 0, 0, ey-1, gy:fy-1, gy))
            end
            checker("SELTZO-TwoSum-POW2-G00-D11-Y",
                ...
                add_case!(lemma,
                    SELTZORange(sy, 1, 1, ey-1, ex, ey-1),
                    SELTZORange(~sx, 0, 0, ex-1, gx:fx-1, gx))
            end
