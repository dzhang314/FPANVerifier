    ...
    for x in abstract_inputs, y in abstract_inputs
        ...
        if x_zero | y_zero ################################### ZERO LEMMA FAMILY
            ...
            checker("SELTZO-TwoSum-ALL1-ALL1-SA-X",
                ...
                add_case!(lemma, SELTZORange(sx, 0, 1, ex+1, ey, ey+1), SELTZORange(sy, 0, 0, fx, fx-p, fy+1))
            end
            checker("SELTZO-TwoSum-ALL1-ALL1-SA-Y",
                same_sign & (cy == ALL1) & (cx == ALL1) &
                (ey == ex + 1)
            ) do lemma
                add_case!(lemma, SELTZORange(sy, 0, 1, ey+1, ex, ex+1), SELTZORange(sx, 0, 0, fy, fy-p, fx+1))
            end
            ...
            checker("SELTZO-TwoSum-ALL1-ALL1-SG-X",
                ...
                add_case!(lemma, SELTZORange(sx, 0, 1, ex+1, ey, ey+1), SELTZORange(sy, 1, 0, fx, fy, fy+1))
            end
            checker("SELTZO-TwoSum-ALL1-ALL1-SG-Y",
                same_sign & (cy == ALL1) & (cx == ALL1) &
                (ey > ex + 1) & (ey < ex + (p-1))
            ) do lemma
                add_case!(lemma, SELTZORange(sy, 0, 1, ey+1, ex, ex+1), SELTZORange(sx, 1, 0, fy, fx, fx+1))
            end
            ...
            checker("SELTZO-TwoSum-ALL1-ALL1-SB1-X",
                ...
                add_case!(lemma, SELTZORange(sx, 0, 0, ex+1, fx+1, gx+1), SELTZORange(sy, 1, 0, fx, fy, fy+1))
            end
            checker("SELTZO-TwoSum-ALL1-ALL1-SB1-Y",
                same_sign & (cy == ALL1) & (cx == ALL1) &
                (ey == ex + (p-1))
            ) do lemma
                add_case!(lemma, SELTZORange(sy, 0, 0, ey+1, fy+1, gy+1), SELTZORange(sx, 1, 0, fy, fx, fx+1))
            end
            ...
            checker("SELTZO-TwoSum-ALL1-ALL1-DA2-X",
                ...
                add_case!(lemma, SELTZORange(sx, 0, 1, ey+2, ey, ey+1), SELTZORange(~sy, 0, 0, fy+1, fy-(p-1), fy+1))
            end
            checker("SELTZO-TwoSum-ALL1-ALL1-DA2-Y",
                diff_sign & (cy == ALL1) & (cx == ALL1) &
                (ey == ex + 2)
            ) do lemma
                add_case!(lemma, SELTZORange(sy, 0, 1, ex+2, ex, ex+1), SELTZORange(~sx, 0, 0, fx+1, fx-(p-1), fx+1))
            end
            ...
            checker("SELTZO-TwoSum-ALL1-ALL1-DB-X",
                ...
                add_case!(lemma, SELTZORange(sx, 1, 0, ex, ey+1, ey+2), SELTZORange(~sy, 0, 0, fy+1, fy-(p-1), fy+1))
            end
            checker("SELTZO-TwoSum-ALL1-ALL1-DB-Y",
                diff_sign & (cy == ALL1) & (cx == ALL1) &
                (ey == ex + p)
            ) do lemma
                add_case!(lemma, SELTZORange(sy, 1, 0, ey, ex+1, ex+2), SELTZORange(~sx, 0, 0, fx+1, fx-(p-1), fx+1))
            end
