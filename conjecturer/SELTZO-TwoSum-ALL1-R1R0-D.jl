function check_seltzo_two_sum_lemmas!(
    ...
    checker("SELTZO-TwoSum-ALL1-R1R0-DG-X",
        (CLASS_X == ALL1) & (CLASS_Y == R1R0) &
        (ex > fy + (p + 1)) & (ex < ey + p)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ALL1-R1R0-DG-Y",
        (CLASS_Y == ALL1) & (CLASS_X == R1R0) &
        (ey > fx + (p + 1)) & (ey < ex + p)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ALL1-R1R0-DGA-X",
        (CLASS_X == ALL1) & (CLASS_Y == R1R0) &
        (ex == fy + (p + 1))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ALL1-R1R0-DGA-Y",
        (CLASS_Y == ALL1) & (CLASS_X == R1R0) &
        (ey == fx + (p + 1))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ALL1-R1R0-DGB0-X",
        (CLASS_X == ALL1) & (CLASS_Y == R1R0) &
        (ex == fy + p) & (ey < fy + (p - 1))
    ) do lemma
        add_case!(lemma, SELTZORange(sx, 1, 0, ex, ey, ey + 1), pos_zero)
    end
    checker("SELTZO-TwoSum-ALL1-R1R0-DGB0-Y",
        (CLASS_Y == ALL1) & (CLASS_X == R1R0) &
        (ey == fx + p) & (ex < fx + (p - 1))
    ) do lemma
    ...
    checker("SELTZO-TwoSum-ALL1-R1R0-DGB1-X",
        (CLASS_X == ALL1) & (CLASS_Y == R1R0) &
        (ex == fy + p) & (ey == fy + (p - 1))
    ) do lemma
        add_case!(lemma, SELTZORange(sx, 0, 0, ex, ex - p, ex), pos_zero)
    end
    checker("SELTZO-TwoSum-ALL1-R1R0-DGB1-Y",
        (CLASS_Y == ALL1) & (CLASS_X == R1R0) &
        (ey == fx + p) & (ex == fx + (p - 1))
    ) do lemma
