function check_seltzo_two_sum_lemmas_l!(
    ...
    checker("SELTZO-TwoSum-LS-T01-X",
        same_sign & (~lbx) & (~tbx) & (~x_pow2) & tby & (~y_all1) &
        (ex > ey + 1) & (fx < gy) & (gx < gy)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-LS-T01-Y",
        same_sign & (~lby) & (~tby) & (~y_pow2) & tbx & (~x_all1) &
        (ey > ex + 1) & (fy < gx) & (gy < gx)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-LD-T01-X",
    ...
    checker("SELTZO-TwoSum-LD-T01-Y",
    ...
    checker("SELTZO-TwoSum-LD-T11-X",
    ...
    checker("SELTZO-TwoSum-LD-T11-Y",
