function check_seltzo_two_sum_lemmas!(
    ...
    checker("SELTZO-TwoSum-ALL1-R1R0-S1AB-X",
        (CLASS_X == ALL1) & (CLASS_Y == R1R0) &
        (ex == ey + (p - 1)) & (ey == fy + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ALL1-R1R0-S1AB-Y",
        (CLASS_Y == ALL1) & (CLASS_X == R1R0) &
        (ey == ex + (p - 1)) & (ex == fx + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ALL1-R1R0-S2B-X",
        (CLASS_X == ALL1) & (CLASS_Y == R1R0) &
        (ex == fy + p)
    ) do lemma
        add_case!(lemma, SELTZORange(sx, 0, 1, ex + 1, ey, ey + 1), pos_zero)
    end
    checker("SELTZO-TwoSum-ALL1-R1R0-S2B-Y",
        (CLASS_Y == ALL1) & (CLASS_X == R1R0) &
        (ey == fx + p)
    ) do lemma
    ...
    checker("SELTZO-TwoSum-ALL1-R1R0-SB-X",
        (CLASS_X == ALL1) & (CLASS_Y == R1R0) &
        (ex == ey + p)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ALL1-R1R0-SB-Y",
        (CLASS_Y == ALL1) & (CLASS_X == R1R0) &
        (ey == ex + p)
    ) do lemma
        add_case!(lemma,
