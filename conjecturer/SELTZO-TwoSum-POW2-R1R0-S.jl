function check_seltzo_two_sum_lemmas!(
    ...
    checker("SELTZO-TwoSum-POW2-R1R0-SG-X",
    ...
    checker("SELTZO-TwoSum-POW2-R1R0-SG-Y",
    ...
    checker("SELTZO-TwoSum-POW2-R1R0-SGA0-X",
        (CLASS_X == POW2) & (CLASS_Y == R1R0) &
        (ex == fy + p) & (ex > ey + 1)
    ) do lemma
        add_case!(lemma, SELTZORange(sx, 0, 1, ex, ey, ey + 1), pos_zero)
    end
    checker("SELTZO-TwoSum-POW2-R1R0-SGA0-Y",
        (CLASS_Y == POW2) & (CLASS_X == R1R0) &
        (ey == fx + p) & (ey > ex + 1)
    ) do lemma
    ...
    checker("SELTZO-TwoSum-POW2-R1R0-SGA1-X",
        (CLASS_X == POW2) & (CLASS_Y == R1R0) &
        (ex == fy + p) & (ex == ey + 1)
    ) do lemma
        add_case!(lemma, SELTZORange(sx, 1, 1, ex, fy, ey + 1), pos_zero)
    end
    checker("SELTZO-TwoSum-POW2-R1R0-SGA1-Y",
        (CLASS_Y == POW2) & (CLASS_X == R1R0) &
        (ey == fx + p) & (ey == ex + 1)
    ) do lemma
    ...
    checker("SELTZO-TwoSum-POW2-R1R0-SGB-X",
        (CLASS_X == POW2) & (CLASS_Y == R1R0) &
        (ex == fy + (p + 1)) & (ex == ey + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-R1R0-SGB-Y",
        (CLASS_Y == POW2) & (CLASS_X == R1R0) &
        (ey == fx + (p + 1)) & (ey == ex + 2)
    ) do lemma
        add_case!(lemma,
