function check_seltzo_two_sum_lemmas!(
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-D3-X",
        (CLASS_X == ONE0) & (CLASS_Y == ALL1) &
        (fx < ey + 1) & (ex > ey + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-D3-Y",
        (CLASS_Y == ONE0) & (CLASS_X == ALL1) &
        (fy < ex + 1) & (ey > ex + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-D3A0-X",
        (CLASS_X == ONE0) & (CLASS_Y == ALL1) &
        (fx == ey + 1) & (ex > fx + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-D3A0-Y",
        (CLASS_Y == ONE0) & (CLASS_X == ALL1) &
        (fy == ex + 1) & (ey > fy + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-D3A1-X",
        (CLASS_X == ONE0) & (CLASS_Y == ALL1) &
        (fx == ey + 1) & (ex == fx + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-D3A1-Y",
        (CLASS_Y == ONE0) & (CLASS_X == ALL1) &
        (fy == ex + 1) & (ey == fy + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-D3B0-X",
        (CLASS_X == ONE0) & (CLASS_Y == ALL1) &
        (ex == ey + 2) & (ex > fx + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-D3B0-Y",
        (CLASS_Y == ONE0) & (CLASS_X == ALL1) &
        (ey == ex + 2) & (ey > fy + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-D3B1-X",
        (CLASS_X == ONE0) & (CLASS_Y == ALL1) &
        (ex == ey + 2) & (ex == fx + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-ONE0-ALL1-D3B1-Y",
        (CLASS_Y == ONE0) & (CLASS_X == ALL1) &
        (ey == ex + 2) & (ey == fy + 2)
    ) do lemma
        add_case!(lemma,
