function check_seltzo_two_sum_lemmas!(
    ...
    checker("SELTZO-TwoSum-POW2-TWO1-S1A0-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO1) &
        (ex == fy + p) & (ey > fy + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO1-S1A0-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO1) &
        (ey == fx + p) & (ex > fx + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO1-S1A1-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO1) &
        (ex == fy + p) & (ey == fy + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO1-S1A1-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO1) &
        (ey == fx + p) & (ex == fx + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO1-S2A-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO1) &
        (ex == fy + (p - 1))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO1-S2A-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO1) &
        (ey == fx + (p - 1))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO1-S3A0-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO1) &
        (ex == fy + (p - 2)) & (ex > ey + 1)
    ) do lemma
        add_case!(lemma, SELTZORange(sx, 0, 1, ex, ey, fy + 1), pos_zero)
    end
    checker("SELTZO-TwoSum-POW2-TWO1-S3A0-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO1) &
        (ey == fx + (p - 2)) & (ey > ex + 1)
    ) do lemma
    ...
    checker("SELTZO-TwoSum-POW2-TWO1-S3A1-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO1) &
        (ex == ey + 1) & (ey == fy + (p - 3))
    ) do lemma
        add_case!(lemma, SELTZORange(sx, 1, 1, ex, ey - 1, fy + 1), pos_zero)
    end
    checker("SELTZO-TwoSum-POW2-TWO1-S3A1-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO1) &
        (ey == ex + 1) & (ex == fx + (p - 3))
    ) do lemma
    ...
    checker("SELTZO-TwoSum-POW2-TWO1-SB1-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO1) &
        (ex == ey + (p - 1))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO1-SB1-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO1) &
        (ey == ex + (p - 1))
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO1-SB20-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO1) &
        (ex == ey + p) & (ey > fy + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO1-SB20-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO1) &
        (ey == ex + p) & (ex > fx + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO1-SB21-X",
        (CLASS_X == POW2) & (CLASS_Y == TWO1) &
        (ex == ey + p) & (ey == fy + 2)
    ) do lemma
        add_case!(lemma,
    ...
    checker("SELTZO-TwoSum-POW2-TWO1-SB21-Y",
        (CLASS_Y == POW2) & (CLASS_X == TWO1) &
        (ey == ex + p) & (ex == fx + 2)
    ) do lemma
        add_case!(lemma,
