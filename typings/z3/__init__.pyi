...
def fpNeg(a: FPRef) -> FPRef: ...
def fpAdd(rm: FPRMRef, a: FPRef, b: FPRef) -> FPRef: ...
def fpSub(rm: FPRMRef, a: FPRef, b: FPRef) -> FPRef: ...
def fpMul(rm: FPRMRef, a: FPRef, b: FPRef) -> FPRef: ...
def fpFMA(rm: FPRMRef, a: FPRef, b: FPRef, c: FPRef) -> FPRef: ...
...
class ModelRef(object):
    @overload
    def eval(self, t: BoolRef, model_completion: bool = False) -> BoolRef: ...
    @overload
    def eval(self, t: ArithRef, model_completion: bool = False) -> IntNumRef: ...
