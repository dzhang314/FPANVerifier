...
def seltzo_two_sum_lemmas(
    ...
    result["SELTZO-TwoSum-R1R0-R1R0-D6-X"] = z3.Implies(
        z3.And(
            diff_sign,
            x_r1r0,
            y_r1r0,
    ...
    result["SELTZO-TwoSum-R1R0-R1R0-D6-Y"] = z3.Implies(
        z3.And(
            diff_sign,
            y_r1r0,
            x_r1r0,
    ...
    result["SELTZO-TwoSum-G00-R1R0-S1-X"] = z3.Implies(
        z3.And(same_sign, x_g00, y_r1r0, ex == ey + (p - one), ex - gx < p - two),
        seltzo_case(
            (sx, 0, 0, ex, fx, ey + one),
            ((sy,), 0, 0, fy + one, fy - (p - one), fy + one),
        ),
    ...
    result["SELTZO-TwoSum-G00-R1R0-S1-Y"] = z3.Implies(
        z3.And(same_sign, y_g00, x_r1r0, ey == ex + (p - one), ey - gy < p - two),
        seltzo_case(
            (sy, 0, 0, ey, fy, ex + one),
            ((sx,), 0, 0, fx + one, fx - (p - one), fx + one),
        ),
    ...
    result["SELTZO-TwoSum-ONE0-ONE1-D2-X"] = z3.Implies(
        z3.And(diff_sign, x_one0, y_one1, ex == ey, fx + one == fy, ex > fx + three),
        seltzo_case_zero((sx, 1, 0, ex - one, fx + one, ex - (p - one))),
    )
    result["SELTZO-TwoSum-ONE0-ONE1-D2-Y"] = z3.Implies(
        z3.And(diff_sign, y_one0, x_one1, ey == ex, fy + one == fx, ey > fy + three),
        seltzo_case_zero((sy, 1, 0, ey - one, fy + one, ey - (p - one))),
    )

    result["SELTZO-TwoSum-G10-POW2-D1-X"] = z3.Implies(
        z3.And(diff_sign, x_g10, y_pow2, ex > ey + one, ey > fx),
        seltzo_case_zero((sx, 1, 0, ex, ey, gx)),
    )
    result["SELTZO-TwoSum-G10-POW2-D1-Y"] = z3.Implies(
        z3.And(diff_sign, y_g10, x_pow2, ey > ex + one, ex > fy),
        seltzo_case_zero((sy, 1, 0, ey, ex, gy)),
    )
    ...
    result["SELTZO-TwoSum-ALL1-G00-D1-X"] = z3.Implies(
        z3.And(diff_sign, x_all1, y_g00, ex == ey, ey == fy + two, fy == gy + two),
        z3.Or(
    ...
    result["SELTZO-TwoSum-ALL1-G00-D1-Y"] = z3.Implies(
        z3.And(diff_sign, y_all1, x_g00, ey == ex, ex == fx + two, fx == gx + two),
        z3.Or(
    ...
    result["SELTZO-TwoSum-ALL1-G00-S1-X"] = z3.Implies(
        z3.And(same_sign, x_all1, y_g00, ex > ey, ex < gy + (p - two), ey == fy + two),
        seltzo_case(
            (sx, 0, 0, ex + one, ey, gy),
            ((sy,), 0, 0, fx + one, fx - (p - one), fx + one),
        ),
    ...
    result["SELTZO-TwoSum-ALL1-G00-S1-Y"] = z3.Implies(
        z3.And(same_sign, y_all1, x_g00, ey > ex, ey < gx + (p - two), ex == fx + two),
        seltzo_case(
            (sy, 0, 0, ey + one, ex, gx),
            ((sx,), 0, 0, fy + one, fy - (p - one), fy + one),
        ),
    ...
    result["SELTZO-TwoSum-ALL1-MM01-S1-X"] = z3.Implies(
        z3.And(
            same_sign, x_all1, y_mm01, ex > ey, ex < fy + (p - three), ey == fy + two
        ),
        seltzo_case(
            (sx, 0, 0, ex + one, ey, gy),
            ((sy,), 0, 0, fx + one, fx - (p - one), fx + one),
    ...
    result["SELTZO-TwoSum-ALL1-MM01-S1-Y"] = z3.Implies(
        z3.And(
            same_sign, y_all1, x_mm01, ey > ex, ey < fx + (p - three), ex == fx + two
        ),
        seltzo_case(
            (sy, 0, 0, ey + one, ex, gx),
            ((sx,), 0, 0, fy + one, fy - (p - one), fy + one),
